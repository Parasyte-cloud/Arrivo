...
// tone="dark" for the navy post-login screens (Profile, Emergency contacts,
// Plan Route). Without it this renders navy text on a navy card, which is why
// those screens were using bare TextInputs and skipping the country code.
  ...
  return (
    <View style={styles.row}>
      <Pressable style={[styles.dialButton, dark && styles.dialButtonDark]} onPress={() => setPickerVisible(true)}>
        <Text style={[styles.dialText, dark && styles.dialTextDark]}>{selected.code} {selected.dial}</Text>
      </Pressable>
      <TextInput
...
const styles = StyleSheet.create({
  ...
  dialTextDark: { color: colors.dark.text },
  numberInputDark: {
    backgroundColor: colors.dark.fieldBg, color: colors.dark.text,
