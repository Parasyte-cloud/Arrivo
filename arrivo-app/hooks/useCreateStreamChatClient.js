...
// opened from inside the app while the user is already signed in, so a
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // rider/driver re-opens the chat screen. Never blocks the rest of
        // the app on a chat-setup failure.
